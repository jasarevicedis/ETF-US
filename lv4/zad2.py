...
while True :
    ...
    tmp = var/260
    volt = var/26
    display.set_pos(245,10)
    display.rotation=1
    display.init()
    display.print('Temp: '+ str(tmp)  + " C")
    display.print('Napon: ' + str(volt) + 'mV')
    #graphics.line(20,20,20,100)
    graphics.line(20, 20, 20, 220, color565(255, 0, 0))
    graphics.line(20, 220, 260, 220, color565(255, 0, 0))
    graphics.fill_circle(20,220-int(tmp),4, color565(255, 0, 0) )
    time.sleep(1)
